				...
				<View style={ModalStyle.modalOuterContainer}>
					<View style={ModalStyle.modalInnerContainerAuto}>
						...
						<View style={ModalStyle.flexLeft}>
							<Text style={ModalStyle.headingText}>{this.props.screenProps.t('claims:submitAllClaims')}</Text>
						</View>
						...
						<LightButton onPress={() => this.props.onSubmit()} text={this.props.screenProps.t('claims:submit')} />
