...
export default class CustomModal extends React.Component<Props, State> {
  renderHeadingImage() {
    if (this.props.headingImage) {
      return (
        <View style={[ModalStyle.flexCenter]}>{this.props.headingImage}</View>
      );
    }
    return null;
  }
    ...
    if (this.props.heading) {
      return (
        <View style={ModalStyle.flexLeft}>
          <Text style={[ModalStyle.headingText, this.props.headingTextStyle]}>
            {this.props.heading}
          </Text>
        </View>
      );
  ...
  renderSecondParagraph() {
    if (this.props.paragraphSecondary) {
      return (
        <View style={ModalStyle.flexLeft}>
          <Text style={ModalStyle.descriptionText}>
            {this.props.paragraphSecondary}
          </Text>
        </View>
      );
    }
      ...
      return (
        <InputField
          ...
          onChangeText={(text: string) =>
            this.props.inputFieldOptions.onChangeText(text)
          }
          underlinePositionRatio={
            this.props.inputFieldOptions.underlinePositionRatio
          }
        />
      );
    }
