  ...
  <TouchableOpacity style={ProjectDetailStyles.photoBoxContainer}>
    <View
      style={[
        ...
        { justifyContent: 'flex-end', flex: 0.1 },
      ]}>
    ...
    <Container>
      ...
      <Content
        ...
        <View
          ...
          <Text
            style={[
              { color: ThemeColors.black, fontSize: 19, fontWeight: '500' },
            ]}>
            sldkce2322kjsdlckd230092
          </Text>
          <Text style={[{ color: ThemeColors.grey, fontSize: 15 }]}>
            Submitted on 04-09-18
          </Text>
        </View>
